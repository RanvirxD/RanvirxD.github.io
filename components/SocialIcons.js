...
export default function SocialIcons() {
  ...
  return (
    <div className="flex flex-wrap gap-2">
      <a href={socials.twitter} className="icon-btn" aria-label="X / Twitter">
        <svg viewBox="0 0 24 24" fill="currentColor">
          <path d="M18.9 2H22l-7.6 8.7L23 22h-6.9l-5.4-6.6L4.5 22H1.4l8.1-9.3L1 2h7l4.9 6.1L18.9 2Z" />
        </svg>
      </a>
      <a href={socials.linkedin} className="icon-btn" aria-label="LinkedIn">
        <svg viewBox="0 0 24 24" fill="currentColor">
      ...
      <a href={socials.github} className="icon-btn" aria-label="GitHub">
        <svg viewBox="0 0 24 24" fill="currentColor">
