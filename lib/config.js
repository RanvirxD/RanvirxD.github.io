...
export const projects = [
  {
    ...
    summary: "AI-based internship recommendation engine with an explainable, hybrid LLM + rule-based matching system.",
    description:
  ...
  },
  {
    ...
    summary: "Distributed hospital management and inter-hospital referral system with live bed and resource tracking.",
    description:
  ...
  },
  {
    ...
    summary: "Real-time multi-language code translator powered by an AST parser fused with LLM inference.",
    description:
